...
void main()
{
    ...
    vec2 pos = ((position * vec2(0.5, 0.5) + vec2(0.5, -0.5)) * canvasSize * scale + wShift) / screenSize;
    gl_Position = vec4(pos * vec2(2.0), 0.0, 1.0);
...
void main()
{
    ...
    if(int(gl_FragCoord.x / 10.0) % 2 + int(gl_FragCoord.y / 10.0) % 2 == 1) {
