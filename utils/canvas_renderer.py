    ...
    for y in range(height):
        for x in range(width):
            ...
            for canvas in canvases:
                ...
                # Apply alpha blending
                a_coef = pixel[3] / 255 * (1 - color[3])

                color[0] = color[0] * color[3] + pixel[0] / 255 * a_coef
                color[1] = color[1] * color[3] + pixel[1] / 255 * a_coef
                color[2] = color[2] * color[3] + pixel[2] / 255 * a_coef
                color[3] = color[3] + a_coef
