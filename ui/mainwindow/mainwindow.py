...
"}")
        ...
        self.colorPickerBox = QtWidgets.QGroupBox(self.brushPanel)
        self.colorPickerBox.setGeometry(QtCore.QRect(20, 440, 40, 40))
        self.colorPickerBox.setAutoFillBackground(False)
        self.colorPickerBox.setStyleSheet("border-radius: 5px;")
        self.colorPickerBox.setTitle("")
        self.colorPickerBox.setFlat(False)
        self.colorPickerBox.setObjectName("colorPickerBox")
        self.transparencyBackground = QtWidgets.QLabel(self.colorPickerBox)
        self.transparencyBackground.setGeometry(QtCore.QRect(0, 0, 40, 40))
        self.transparencyBackground.setStyleSheet("")
        self.transparencyBackground.setText("")
        self.transparencyBackground.setPixmap(QtGui.QPixmap("assets/transparency.png"))
        self.transparencyBackground.setScaledContents(True)
        self.transparencyBackground.setObjectName("transparencyBackground")
        self.currentColorButton = QtWidgets.QPushButton(self.colorPickerBox)
        self.currentColorButton.setGeometry(QtCore.QRect(0, 0, 40, 40))
        self.currentColorButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.currentColorButton.setAutoFillBackground(False)
        self.currentColorButton.setStyleSheet("background-color: rgba(255, 255, 255, 1);")
        self.currentColorButton.setText("")
        self.currentColorButton.setIconSize(QtCore.QSize(40, 40))
        self.currentColorButton.setAutoRepeat(False)
        self.currentColorButton.setFlat(False)
